...
class InstaBot:
    ...
    def loging_in(self, username, password):
        ...
        sleep(3)
        not_now_button_two = self.driver.find_element(
            By.XPATH,
            '//button[text()="Not Now"]'
        )
    ...
    def following_function(self):
        followers_buttons = self.driver.find_elements(
            By.CSS_SELECTOR,
            "div ._ab8w ._ab94._ab97._ab9f._ab9k._ab9p \
            ._ab9-._aba8._abcm button ._acan._acap._acas"
        )
    ...
    # For searching, switching accounts, following and scrolling
    def bot_action(self, number_of_accounts: int, searching_term: str):
        sleep(5)
        search_button = self.driver.find_element(
            By.CSS_SELECTOR,
            'div ._aawf._aawg input ._aauy div ._aaw8'
        )
        search_button.click()
        ...
        while index_no < number_of_accounts:
            ...
            if "/tags/" in link.get_attribute('href'):
                ...
                self.driver.back()
                sleep(2)
                search_button_two = self.driver.find_element(
                    By.XPATH,
                    '//span[text()="Books"]'
                )
...
Bot.loging_in(username=user_name, password=passcode)
Bot.bot_action(number_of_accounts=5,
               searching_term="Books")
